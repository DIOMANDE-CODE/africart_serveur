...
urlpatterns = [
    ...
    path(
        "list/<str:email_client>/", liste_commande_client, name="liste_commande_client"
    ),
    path(
        "zone_livraison/list/",
        voir_frais_livraison_zone,
        name="voir_frais_livraison_zone",
    ),
]

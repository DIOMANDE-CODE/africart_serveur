...
class UpdateProduit(graphene.Mutation):
    ...
    def mutate(root, info, identifiant_produit, nom_produit=None, categorie_produit=None, prix_unitaire_produit=None, quantite_produit_disponible=None, seuil_alerte_produit=None):
        try:
...
class Query(graphene.ObjectType):
    ...
    product = graphene.Field(ProduitType, identifiant_produit=graphene.UUID(required=True))

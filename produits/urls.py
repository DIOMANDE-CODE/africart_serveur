...
from .views import (
    ...
    delete_produit,
    alertes_actives,
    list_produit_pour_personnel,
    noter_produit,
    note_moyenne_produit,
)
...
urlpatterns = [
    ...
    path(
        "detail/categorie/<str:identifiant>/", detail_categorie, name="detail_categorie"
    ),
    path(
        "delete/categorie/<str:identifiant>/", delete_Categorie, name="delete_categorie"
    ),
    # Produits
    ...
    path(
        "list/personnel/",
        list_produit_pour_personnel,
        name="list_produit_pour_personnel",
    ),
    ...
    path(
        "note_moyenne/<str:identifiant_produit>/",
        note_moyenne_produit,
        name="note_moyenne_produit",
    ),
]

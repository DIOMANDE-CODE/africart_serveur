...
from .views import login_utilisateur,logout_utilisateur, check_session,changer_mot_de_passe
...
urlpatterns = [
    ...
    path('changer_mot_de_passe/', changer_mot_de_passe,name='check_session'),
]

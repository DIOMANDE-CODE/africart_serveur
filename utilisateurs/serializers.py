...
from .models import Utilisateur, DEFAULT_PROFILE_PHOTO
...
class UtilisateurSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        ...
        if not instance.photo_profil_utilisateur:
            ...
            representation["photo_profil_utilisateur"] = (
                instance.photo_profil_utilisateur.url
                if hasattr(instance.photo_profil_utilisateur, "url")
                else str(instance.photo_profil_utilisateur)
            )
